...
public final class SectionStorage {
    ...
    private final Map<Long, RenderWorld.LayeredSectionMesh> layeredMeshes = new HashMap<>();
    ...
    public void putLayeredMesh(RenderWorld.LayeredSectionMesh mesh) {
        layeredMeshes.put(packKey(mesh.chunkX(), mesh.chunkZ(), mesh.y()), mesh);
    }

    public RenderWorld.LayeredSectionMesh getLayeredMesh(long chunkX, long chunkZ, int y) {
        return layeredMeshes.get(packKey(chunkX, chunkZ, y));
    }
